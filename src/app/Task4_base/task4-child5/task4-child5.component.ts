...
@Component({
  selector: 'app-task4-child5',
  templateUrl: './task4-child5.component.html',
  styleUrls: ['./task4-child5.component.css']
})
export class Task4Child5Component implements OnInit {
